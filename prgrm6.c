#include <stdio.h>
#include <stdlib.h>
// #define clrscr();   // Non-standard, commented out

// Bit struct for representing presence
struct bit {
    unsigned char x:1;
};

// Universal set and its size
...
int main() {
    ...
    // clrscr(); // Use system("cls"); if on Windows, otherwise ignore
